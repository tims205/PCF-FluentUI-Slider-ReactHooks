...
import { IMySliderHooksProps, MySliderHooks } from "./MySliderHooks";

export class FluentUISliderReactHooks implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	private renderControl(context: ComponentFramework.Context<IInputs>) {
		...
		let props:IMySliderHooksProps = {
			sliderValue: sliderValue == null ? 0: sliderValue,
